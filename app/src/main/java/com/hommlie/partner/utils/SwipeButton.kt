...
import com.hommlie.partner.utils.Constants.BTN_INIT_RADIUS
import com.hommlie.partner.utils.Constants.BTN_MORPHED_RADIUS
import com.hommlie.partner.utils.Constants.DEFAULT_SWIPE_DISTANCE
import com.hommlie.partner.utils.Constants.DEFAULT_TEXT_SIZE
import com.hommlie.partner.utils.Constants.MORPH_ANIM_DURATION
    ...
    private val handler = Handler(Looper.getMainLooper())
        ...
        private fun setAttrs(context: Context, attrs: AttributeSet) {
            ...
            try {
                ...
                if (btnString != null)
                    btnText = btnString
                textColorInt = a.getColor(R.styleable.SwipeButton_text_color, ContextCompat.getColor(context, R.color.white))
                bgColorInt = a.getColor(R.styleable.SwipeButton_bg_color, ContextCompat.getColor(context, R.color.color_primary))
                arrowColorRes = a.getColor(R.styleable.SwipeButton_arrow_color, ContextCompat.getColor(context, R.color.swipebtn_translucent_white))
                cornerRadius = a.getFloat(R.styleable.SwipeButton_btn_radius, BTN_INIT_RADIUS.toFloat())
                textSize = a.getDimensionPixelSize(R.styleable.SwipeButton_text_size, DEFAULT_TEXT_SIZE.toInt()).toFloat()
            } finally {
                a.recycle()
            }
        }
        ...
        fun init() {
            ...
            view = inflater.inflate(R.layout.viewswipebtn, this, true)
        }
        ...
        fun morphToCircle() {
            CommonMethods.animateFadeHide(contextl, arrowHintContainer)
            ...
            widthAnimation = ValueAnimator.ofInt(width, CommonMethods.dpToPx(50))
            ...
            val heightAnimation = ValueAnimator.ofInt(height, CommonMethods.dpToPx(50))
        ...
        private fun morphToRect() {
            ...
            val heightAnimation = ValueAnimator.ofInt(CommonMethods.dpToPx(50), width)
            heightAnimation.addUpdateListener { valueAnimator ->
                val `val` = valueAnimator.animatedValue as Int
                val layoutParams = contentContainer!!.layoutParams
                layoutParams.height = `val`
        ...
        fun showResultIcon(isSuccess: Boolean, shouldReset: Boolean = !isSuccess) {
            ...
            CommonMethods.animateFadeHide(contextl, progressBar)

            val failureIcon = AppCompatImageView(contextl)
            val icLayoutParams = RelativeLayout.LayoutParams(CommonMethods.dpToPx(50), CommonMethods.dpToPx(50))
            ...
            CommonMethods.animateFadeShow(contextl, failureIcon)
